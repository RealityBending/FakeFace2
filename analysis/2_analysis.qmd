...
This model examined the effects of Gender, Relevance, and Condition on the probability of rating an images as Real, accounting for participants as random intercepts, and included a non-linear effect of Attractiveness by modeling it as a second-degree polynomial.
...
pred <- rbind(pred_attr, pred_beauty, pred_trust)
...
- The attractivenes, beauty and trustworthy model with relevance and condition as random slopes for stimuli were singular.
